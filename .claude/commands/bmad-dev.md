...
Sophie knows:
- Python/FastAPI/LangGraph patterns
- The tool pattern in `app/tools.py`
- The WebSocket handlers in `bridge/telephony.py`
- Testing conventions

## Start

Read and follow the instructions in `_bmad/garage/agents/developer.md`.
