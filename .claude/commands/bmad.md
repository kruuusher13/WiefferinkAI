...
Available agents:
- 📋 **Jan** (PM) - `/bmad-pm` - Requirements and user stories
- 🏗️ **Willem** (Architect) - `/bmad-architect` - System design
- 💻 **Sophie** (Developer) - `/bmad-dev` - Implementation
...
- `/bmad-bugfix` - Bug investigation and fix
- `/bmad-review` - Code review
- `/bmad-release` - Release preparation

## Start

Read and follow the instructions in `_bmad/core/agents/bmad-master.md`.
